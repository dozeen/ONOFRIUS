/**
 * test-tone-engine.js - Test di verifica del ToneEngine e dell'Adattamento Dinamico del Registro Relazionale in ONOFRIUS
 */

const toneEngine = require("./packages/gordon-core/personality/ToneEngine");
