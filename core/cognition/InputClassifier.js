...
class InputClassifier {
    ...
    classify(text, factsPayload = {}) {
        ...
        // 2. Intenzioni / Pensieri (es. "Vorrei comprare una moto", "Pensiero: ...")
        ...
        // 4. Preferenze (es. "Preferisco comunicare via email")
        if (lower.startsWith("preferenza:") || lower.startsWith("preferisco ")) {
            return {
        ...
        // 5. Promemoria / Agenda (es. "Domattina quando ti dà il buongiorno tu ricordagli...")
        if (lower.startsWith("ricordami ") || lower.startsWith("domattina ") || lower.startsWith("agenda:")) {
            return {
