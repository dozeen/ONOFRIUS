...
class ToneEngine {
    evaluateTone(context) {
        ...
        return {
            tone: "casual",
            instruction: `Rispondi come scriverebbe ${ownerName} su WhatsApp: calmo, diretto, spontaneo. Non cercare sempre di essere utile: se il messaggio è solo affettuoso, scherzoso o di cortesia, mantieni lo stesso tono.`
        };
    }
}
