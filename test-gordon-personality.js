...
const moodEvaluator = require("./packages/gordon-core/cognition/interaction/InteractionMoodEvaluator");
const ResponseHandler = require("./packages/gordon-core/brain/handlers/ResponseHandler");
